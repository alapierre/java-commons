...
public class RSAGen {
    ...
    public static void main(String args[]) throws Exception {
        ...
        ArmoredOutputStream pubout = new ArmoredOutputStream(new BufferedOutputStream(new FileOutputStream("/tmp/dummy.asc")));
        pkr.encode(pubout);
        pubout.close();

        // Generate private key, dump to file.
        PGPSecretKeyRing skr = krgen.generateSecretKeyRing();
        BufferedOutputStream secout = new BufferedOutputStream(new FileOutputStream("/tmp/dummy.skr"));
        skr.encode(secout);
        secout.close();
    }
